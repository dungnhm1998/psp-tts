...
public class ShopifyListBaseHandler implements Handler<RoutingContext> {
	...
	private static final Logger LOGGER = Logger.getLogger(ShopifyListBaseHandler.class.getName());
}
