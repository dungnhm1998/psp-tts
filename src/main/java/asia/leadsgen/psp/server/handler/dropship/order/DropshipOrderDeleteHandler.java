...
public class DropshipOrderDeleteHandler implements Handler<RoutingContext> {
	...
	public void handle(RoutingContext routingContext) {
		...
		routingContext.vertx().executeBlocking(future -> {
			try {
				...
				orderInfoMap = DropshipOrderService.deleteOrder(orderId);
	...
	private static final Logger LOGGER = Logger.getLogger(DropshipOrderDeleteHandler.class.getName());
}
