...
public class ShopifySearchProductStateHandler implements Handler<RoutingContext> {
	...
	public void handle(RoutingContext routingContext) {
		...
		routingContext.vertx().executeBlocking(future -> {
			...
			try {
				...
				Map productSearchResult = ShopifyAppService.searchProductState(storeName, content, status, page, pageSize);
	...
	private static final Logger LOGGER = Logger.getLogger(ShopifySearchProductStateHandler.class.getName());
}
